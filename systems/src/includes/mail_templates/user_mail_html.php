...
<table cellspacing="0" border="0" cellpadding="0" width="100%" style="border:none; padding:0px; margin:0px;">
    <tr>
        <td style="border:0; padding: 9px 0 15px 0; background:#ffffff; text-align:left; border-bottom:1px solid #D8D8D8; margin:0px;">
            <a target="_blank" href="{{WEBSITE}}" border="0" style="float:left; "><img style="margin:0; border:none; " alt="" src="{{ROOT}}config/logo_small.png"></a>
        </td>
    </tr>
</table>
<!-- / header -->
                ...
                <tr>
                    <td>
                        ...
                        <table cellspacing="0" border="0" cellpadding="0" width="700">
                            ...
                            <tr>
                                <td valign="top" style="padding: 20px 20px 20px 20px; font-size: 14px; font-family: Arial; line-height: 20px; color:#6A6A6A;" colspan="2">
                                <br/>{{CONTENT}}
                                </td>
                            </tr>
                            ...
                            <!-- extra -->
                            <tr>
                                <td valign="top" style="padding:20px; color: #000; font-size: 11px; font-family: Arial; line-height: 20px; color:#6A6A6A; border-top:1px dotted #eaeae6;" colspan="2">
                                <b>System Login URL:</b> <a target="_blank" href="{{WEBSITE}}">{{WEBSITE}}<a><br/>
                                </td>
                            </tr>
                            <!--  / extra -->
