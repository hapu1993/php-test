                ...
                <tr>
                    <td class="one-column">
                        <table width="100%" class="content">
                            <tr>
                                <td class="contents">
                                    You have been set up as a new user on the {{CLIENT}} system.
                                    <br/><br/>
                                    Your username is: {{USERNAME}}<br/>
                                    You can create your password using <a href="{{WEBSITE}}{{PASSWORD_LINK}}">this link</a><br/>
                                    This link has a timed expiry of {{EXPIRY}}.
                                    <br/><br/>
                                    Once you have created your password, you can login on <a href="{{WEBSITE}}">this page</a>.<br/>
                                    For any queries or further infomation, please email <a href="mailto:{{SYSTEM_EMAIL}}">{{SYSTEM_EMAIL}}</a>.
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="one-column">
                        <table width="100%" class="system_login">
                            <tr>
                                <td>
                                    <b>System Login URL:</b> <a target="_blank" href="{{WEBSITE}}">{{WEBSITE}}<a>
                                </td>
                            </tr>
                        </table>
                    </td>
