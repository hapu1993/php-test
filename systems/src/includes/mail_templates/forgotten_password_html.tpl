                ...
                <tr>
                    <td class="one-column">
                        <table width="100%" class="content">
                            <tr>
                                <td class="contents">
                                    Your request for a password reset has been forwarded to the System Administrator who will have to reactivate your account.
                                    Once the account is activated you will be notified by email.
                                    <br/><br/>
                                    Your username is: {{USERNAME}}<br/>
                                    You can reset your password using <a style="text-decoration: none;" href="{{ROOT}}{{PASSWORD_LINK}}">this link</a><br/>
                                    This link has a timed expiry of {{EXPIRY}}.
                                    <br/><br/>
                                    Once you have created your password, and the System Administrator has reactivated your account you can login on <a href="{{ROOT}}">this page</a>.<br/>
                                    For any queries or further infomation, please email <a style="text-decoration: none;" href="mailto:{{SYSTEM_EMAIL}}">{{SYSTEM_EMAIL}}</a>.
                                </td>
                            </tr>
                        </table>
                    </td>
