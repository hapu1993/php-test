...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <style type="text/css">
        ...
        .one-column .contents_comment { text-align: left; padding-bottom: 20px; }
        .one-column .contents_user { text-align: left; border-top:1px dotted #eaeae6; padding-top: 20px; }
                ...
                <tr>
                    <td class="one-column">
                        <table width="100%" class="content">
                            <tr>
                                <td class="contents_comment">
                                    {{COMMENT}}
                                </td>
                            </tr>
                            <tr>
                                <td class="contents_user">
