...
$locationLabel = str_plural($libhtml->local_text['Location']);
$wardsLabel = str_plural($libhtml->local_text['Ward']);
...
$libhtml = new Libhtml(array(
    ...
    "title" => "Ward Security Group Details - ".$wardSecurityGroups->name,
    "show_back"=> true,
));
